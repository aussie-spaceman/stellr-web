...
export default async function CampaignsPage() {
  ...
  return (
    <>
      ...
      {/* ── See a real student RFP (gated download) ───────────────────── */}
      <section className="section-padding bg-gradient-to-b from-surface to-white border-y border-line">
        <div className="container-max max-w-2xl flex flex-col items-center text-center">
          ...
          <div className="mt-8 flex flex-col items-center">
            <AssetGate
              ...
              triggerClassName="inline-flex items-center justify-center gap-2 rounded-[10px] bg-primary px-8 py-4 font-display text-base font-semibold text-white shadow-card-lift hover:bg-primary-deep transition-colors"
            />
          </div>
        </div>
      </section>
      ...
      {/* ── Campaigns ─────────────────────────────────────────────────── */}
      {/* ── See what students create (rotating showcase) ───────────────── */}
      <section className="section-padding bg-white">
        <div className="container-max">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div>
              <Eyebrow>Previous student work</Eyebrow>
              <h2 className="text-3xl font-bold text-ink mt-3">See what students create</h2>
              <p className="text-content-secondary mt-3 leading-relaxed max-w-lg">
                A rotating look at real deliverables from past competitions — the proposals,
                presentations and designs your students could be building.
              </p>
            </div>
            <StudentWorkHero />
          </div>
      ...
      {/* ── Campaigns ─────────────────────────────────────────────────── */}
      <section id="campaigns" className="section-padding bg-surface scroll-mt-24">
        <div className="container-max">
