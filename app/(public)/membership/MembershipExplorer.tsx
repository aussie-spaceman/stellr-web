        ...
        <div className="max-w-[1180px] mx-auto px-6 py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div className="bg-white border border-line rounded-2xl py-7 px-7 pl-8 relative border-l-[3px] border-l-primary">
              <p className="text-[15px] leading-[1.65] text-line italic mb-5">[School student quote — to be provided]</p>
              <div className="flex items-center gap-2.5"><div className="w-9 h-9 rounded-full bg-primary-soft shrink-0" /><p className="font-semibold text-[14px] text-line">[Name · Year · Tier]</p></div>
            </div>
            <div className="bg-white border border-line rounded-2xl py-7 px-7 pl-8 relative border-l-[3px] border-l-space-violet">
              <p className="text-[15px] leading-[1.65] text-line italic mb-5">[College student quote — to be provided]</p>
              <div className="flex items-center gap-2.5"><div className="w-9 h-9 rounded-full bg-space-violet-bg shrink-0" /><p className="font-semibold text-[14px] text-line">[Name · Year · Tier]</p></div>
            </div>
            <div className="bg-white border border-line rounded-2xl py-7 px-7 pl-8 relative border-l-[3px] border-l-enviro-green">
              <p className="text-[15px] leading-[1.65] text-line italic mb-5">[Educator quote — to be provided]</p>
              <div className="flex items-center gap-2.5"><div className="w-9 h-9 rounded-full bg-enviro-green-bg shrink-0" /><p className="font-semibold text-[14px] text-line">[Name · Role · Tier]</p></div>
            </div>
          </div>
        </div>
      </section>
