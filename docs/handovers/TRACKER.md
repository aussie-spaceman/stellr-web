...
| 8.5 | Admin "Send pay link" button unverified in a browser | Route unit-tested; button not clicked — seed event has no Sanity doc. | Click it once on dev against a real event slug. | ☐ |
